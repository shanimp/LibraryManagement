...
class SearchWindow(QMainWindow):
    def __init__(self):
        ...
        self.ui.btnadd.clicked.connect(self.open_add_book)
        #self.ui.btnedit.clicked.connect(self.open_edit_book)
        #self.ui.btndelete.clicked.connect(self.open_delete_book)
        #self.ui.btnview.clicked.connect(self.open_view)
        #self.ui.btnothers.clicked.connect(self.open_others)
